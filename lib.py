...
class GlobalGraph(nn.Module):
    def __init__(self, hidden_size, attention_head_size=None, num_attention_heads=1, attention_decay=False):
        ...
        self.attention_decay = nn.Parameter(torch.ones(1) * 0.5) if attention_decay else None
